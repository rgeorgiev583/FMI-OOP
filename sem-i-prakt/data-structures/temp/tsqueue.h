...
public:
    ...
    /// -- по подразбиране
    TwoStackQueue();
    /// -- за създаване от стек (копира се в push_stack)
    TwoStackQueue(const Stack&);
    /// -- за създаване от два стека (копират се съответно в push_stack и pop_stack)
    TwoStackQueue(const Stack&, const Stack&);
