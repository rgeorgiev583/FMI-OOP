...
public:
    ...
    bool isOrthogonalCoordinateSystem(const Vector&) const; /// връща дали може да се образува ОКС (ортонормирана координатна ситема) от вектора и подадения като параметър вектор
